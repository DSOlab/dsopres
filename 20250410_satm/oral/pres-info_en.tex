...
%% Add "thank you" text% 
\thankutext{Ευχαριστούμε!! || Thank you!!}
...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{Geodetic monitoring of Santorini wider area}

%% The team prepare this presentation
\presteam{Dimitris Anastasiou,
Kostas Raptakis,
...
\presorgn{Dionysos Satellite Observatory | Laboratory of Geodesy\\ School of Rural, Surveying and Geoinformatics Engineering \\ National Technical University of Athens\\
}
...
%% OR conf logo....
\conflogo{
\includegraphics[width=2cm,draft=false]{Figs/satm-logo.png}
\begin{minipage}{2cm}
\begin{flushright}
\vskip-1cm
\textit{Monday}\\
...
\begin{flushleft}
\vskip-1cm
\textbf{Geodetic Campaign ΥΦΑΙΣΤΙΣ 2025}\\
Geodetic and geophysical observations\\
    Santorini-Anafi Islands\\
Hellenic Military Geographical Service
\end{flushleft}
\end{minipage}
\includegraphics[width=2cm,draft=false]{Figs/hmgs_logo.png}
}
