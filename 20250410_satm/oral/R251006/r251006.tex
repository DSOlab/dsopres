...
- Station ΝΟΜΙ is available in collaboration with University of Patras and EarthScope.
\end{scriptsize}
...
% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{What's going on so far?}
  \framesubtitle{}
  \label{}
  \vskip-1cm
  \begin{columns}[T]
    \begin{column}{.25\textwidth}
      \begin{center}
      {\scriptsize SANT (Imerovigli)}
        \includegraphics[width=.97\textwidth]{snt2-mod2.png}
      \end{center}  
    \end{column}
    \begin{column}{.25\textwidth}
      \begin{center}
       {\scriptsize 048A (Thira)}
        \includegraphics[width=.97\textwidth]{048a-mod2.png}
      \end{center}  
    \end{column}
    \begin{column}{.25\textwidth}
      \begin{center}
       {\scriptsize SNTJ (Perissa)}
        \includegraphics[width=.97\textwidth]{sntj-mod2.png}
      \end{center}       
    \end{column}
    \begin{column}{.25\textwidth}
      \begin{center}
       {\scriptsize RIV2 (RIVA)}
        \includegraphics[width=.97\textwidth]{riv2-mod2.png}
      \end{center}       
    \end{column}
  \end{columns}  
...
\note{}
 ...
 % ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Station velocities 2025 3/3 - 8/9}
  \framesubtitle{}
  \label{}
  \vskip-.5cm
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth]{sant_20250303_20250908_vhor.jpg}
      \end{center}  
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth]{sant_20250303_20250908_vver.jpg}
      \end{center}       
    \end{column}
  \end{columns}  
