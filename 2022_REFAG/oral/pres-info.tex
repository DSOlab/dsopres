...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{On the stability of regional reference frames in Greece using GNSS permanent stations. }

%% The team prepare this presentation
\presteam{
\underline{Dimitris Anastasiou},
...
%% OR conf logo....
\conflogo{\includegraphics[width=.45\textwidth,draft=false]{Figs/REFAG2022_logo.png}}
