...
\begin{frame}\frametitle{Motivation}\framesubtitle{}
  ...
  \begin{itemize}
    ...
    \item contribute to the GNSS community and be involved in ongoing/future projects,
...
\begin{column}{.40\textwidth}
  ...
  \begin{itemize}
    ...
    \item<pro@1-> Region of Greece
    \item<pro@1-> different (geodetic type) equipment
    \item<pro@1-> credible time-span (early 2004 - late 2020)
    \item<con@1-> All free available GNSS data
%    \item<con@1-> 
...
\begin{column}{.28\textwidth}
   ...
   Integration with
   \begin{itemize}
     \item \texbf{MySQL} database,
     \item \texbf{Python} module (product/data downloading, pre-processing, 
      driving cron jobs, parsing result files, etc)
     \item \texbf{Time-series} analysis (in-house software, incorporated in 
      routine processing on regular intervals)
     \item \texbf{Strain Rates} via StrainTool (on user demand)
   \end{itemize}
\end{column}%
\hfill%
