...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{Update on DSO’s contribution to EUREF Densification and new activities}
...
%% OR conf logo....
\conflogo{\includegraphics[width=.85\textwidth,draft=false]{Figs/EUREF2024_logo.png}}
