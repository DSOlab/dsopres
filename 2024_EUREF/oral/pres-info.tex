...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{DSO contribution to EUREF Densification\\ and a dense velocity field for Greece}
...
%% OR conf logo....
\conflogo{\includegraphics[width=.85\textwidth,draft=false]{Figs/EUREF2023_logo.png}}
