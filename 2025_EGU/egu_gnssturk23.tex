...
\begin{center}
  ...
  Fig.1:Tectonic backround (a) and focal mechanisms (b) of
2023 Turkey earthquake doublet
\end{center}
...
\renewcommand{\thebibliography}[1]{%
  ...
  \setlength{\itemsep}{0.3ex} % Less space between refs
...
\headerbox{Aknowledgment}{name=funding,column=3,aligned=references,above=bottom}{ 
\label{aknowledgment}
