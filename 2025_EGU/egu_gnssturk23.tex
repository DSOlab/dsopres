...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=6.5em]{../../logos/ntua.png} \hspace*{0.5cm}\includegraphics[height=6em]{../../logos/UoN-Nottingham-Blue.png}} %\includegraphics[height=6.5em]{../../logos/noa1.png}} % First university/lab logo on the left
...
{\small \par{$^{1}$National Technical University of Athens, School of Rural, Surveying and Geoinformatics Engineering, Greece (danastasiou@mail.ntua.gr)}
...
{\includegraphics[height=6em]{../../logos/egu25_logo.png}} % \includegraphics[height=6.5em]{../../logos/logo_uoa_blue.png}} % Second university/lab logo on the right
%----------------------------------------------------------------------------------------
%	INTRODUCTION
%----------------------------------------------------------------------------------------
...
\begin{minipage}[c]{.18\linewidth}
  \includegraphics[width=.97\textwidth]{egu25-18416-qr.png}
\end{minipage}
...
\headerbox{Time series Analysis}{name=data,column=2, span=2,row=0}{
\label{ts_analysis}
...
\label{datanet}
 41 continuously operating stations located near the earthquake sequence in southwest Turkey (<500km distance from epicentre), and an additional 54 far-field stations distributed across the Aegean Sea and mainland Greece in a distance of 500 to 1000km from the two earthquakes epicentre. 

\begin{minipage}[c]{0.97\linewidth}
  \fbox{\includegraphics[width=\textwidth]{allstations.png}}
\end{minipage}
...
\headerbox{Data Analysis}{name=algorithms,column=1,row=0}{ 
\label{dataanalysis}
Data from all available operating stations were analysed.\\
...
\headerbox{TS1}{name=tsa1,column=1,row=0, below=algorithms, bottomalign=resval}{ 
\label{tsanalysis1}


\textbf{1. Pre-processing and Filtering of GNSS Data}

Low-frequency noise in the GNSS data—likely caused by multipath effects, unmitigated tropospheric delays, and other sources—was suppressed using a high-pass Butterworth filter with a cut-off frequency of 0.1 Hz. This filter effectively removed slow variations without significantly affecting any potential dynamic displacements. Since the GNSS stations were located more than 800 km from the earthquake epicenters, no co-seismic displacements were expected.

\textbf{2. Transient Response Detection and Noise Estimation}
