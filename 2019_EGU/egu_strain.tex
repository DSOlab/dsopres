...
\begin{tcolorbox}[height=2.5em,width=.7\textwidth,colback={airforceblue}, colupper=white,  boxrule=0pt]    
 \textbf{Abstract Number:  EGU2019-17444}
\end{tcolorbox}  
 \end{center}
...
\headerbox{Velocity field - ETRF2014}{name=data,column=2, span=2,row=0}{
% \vfill
...
{\scriptsize
\textbf{Altamimi Z.}, L. M\'etivier, P. Rebischung, H. Rouby, and X. Collilieux (2017) ITRF2014 plate motion model, Geophysical Journal International, Volume 209, Issue 3, 1 June 2017, Pages 1906-1912, https://doi.org/10.1093/gji/ggx136.
...
\headerbox{FUNDING BY HELPOS \& EPOS}{name=funding,column=3,aligned=references,above=bottom}{ 
