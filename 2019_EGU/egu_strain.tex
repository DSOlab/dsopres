...
\headerbox{Velocity field}{name=data,column=1,row=0,bottomaligned=introduction}{
...
on \textbf{Veis st al} or \textbf{Shen et al}. In the latter case, a sophisticated weighting
