...
\institute{National Technical University of Athens\\ \vspace{0.3em} \par{  School of Rural and Surveying Engineering, Dionysos Stallite Observatory}} % Institution(s)
...
Currently, we have focused our efforts in reprocessing all the available GNSS data up to date, via Bernese GNSS Software v5.2. 

In this study we present the final scheme of this platform, that invcludes data archive, prossecings, dissemination of results and products
.
