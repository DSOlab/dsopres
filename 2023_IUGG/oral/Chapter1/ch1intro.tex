...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{.6\textwidth}
      \begin{center}
%  \vskip-.5cm
        \includegraphics[width=.97\textwidth]{geotectonic.jpg}
      \end{center}     
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{center}
  \vskip-.5cm
    \includegraphics[width=.8\textwidth]{supersite_intro.png}
  \end{center}
  \href{https://greeksupersite.eu/}{https://greeksupersite.eu/}
\end{frame}
\note{}

\begin{frame}\frametitle{DSO Recent Activity and motivation}\framesubtitle{}\label{}
\vskip-1cm
...
\begin{frame}\frametitle{Network EnCeladus}\framesubtitle{}
\vskip-1cm
...
\begin{frame}\frametitle{Compliance wrt EUREF standards and upgrade planning}\framesubtitle{}
\vskip-.5cm
  ...
  \begin{itemize}%%[label={\checkmark}]
    ...
    \item Reference frame \texttt{\textcolor{red}{IGb14}},(\texttt{\textcolor{blue}{$\dashrightarrow$ IGS20}})
    \item \texttt{IERS} Conventions 2010,
    \item \texttt{IGS}/\texttt{CODE} products, (\textcolor{blue}{$\dashrightarrow$ Long filename of products} according to new IGS convention)
    \item ocean loading corrections (\texttt{\textcolor{red}{FES2004}}),(\texttt{\textcolor{blue}{$\dashrightarrow$ FES2014}})
    %\item atmospheric tidal loading corrections,
    \item $3^{\circ}$ elevation cut-off angle; elevation dependent weighting,
    \item \texttt{GMF} and/or \texttt{\textcolor{red}{VMF1}}; \texttt{Chen-Herring} gradient parameter, \texttt{\textcolor{blue}{$\dashrightarrow$ VMF3}}
    \item amiguities fixed (length-dependent algorithm),
    \item use \texttt{GLONASS} obs (when available)
    \item use \texttt{ATX} files  (\textcolor{red}{epn\_14.atx}) - \textcolor{red}{individual calibrations} (\texttt{\textcolor{blue}{$\dashrightarrow$ igs20.atx}})
  \end{itemize}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{.25\textwidth}
      \begin{center}
      Station: 011A
        \includegraphics[width=.97\textwidth]{011a_0_data.png}\\
        \includegraphics[width=.97\textwidth]{011a_1_data.png}\\
        \includegraphics[width=.97\textwidth]{011a_2_data.png}
      \end{center}
    \end{column}
    \begin{column}{.25\textwidth}
      \begin{center}
      Residuals
        \includegraphics[width=.97\textwidth]{011a_0_res.png}\\
        \includegraphics[width=.97\textwidth]{011a_1_res.png}\\
        \includegraphics[width=.97\textwidth]{011a_2_res.png}
      \end{center}
    \end{column}
    \begin{column}{.25\textwidth}
       \begin{center}
       Station: EYPA
        \includegraphics[width=.97\textwidth]{eypa_0_data.png}\\
        \includegraphics[width=.97\textwidth]{eypa_1_data.png}\\
        \includegraphics[width=.97\textwidth]{eypa_2_data.png}
      \end{center}
    \end{column}
    \begin{column}{.25\textwidth}
      \begin{center}
      Residuals
        \includegraphics[width=.97\textwidth]{eypa_0_res.png}\\
        \includegraphics[width=.97\textwidth]{eypa_1_res.png}\\
        \includegraphics[width=.97\textwidth]{eypa_2_res.png}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\note{}
 ...
 % ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Corinth Gulf}
  \framesubtitle{IGb14 || Stable Europe}
  \label{}
  \vskip-.5cm
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth]{cr_igb14-output_vel.jpg}  
      \end{center}
      \begin{table}[H]{\small
      \begin{center}
      \begin{tabular*}{.97\linewidth}{@{\extracolsep{\fill}} l c c c}
        \toprule
          (mm/yr) & N & E & U\\
        \midrule
         min & -13.0  & 7.5 & -9.0 \\
    ...
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth]{cr_feu-output_vel.jpg}  
      \end{center}
            \begin{table}[H]{\small
      \begin{center}
      \begin{tabular*}{.97\linewidth}{@{\extracolsep{\fill}} l c c c}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.89\textwidth, trim={0 0 0 1cm},clip]{cr_flepe-output_vel.jpg}\\[.1em]
        \includegraphics[width=.89\textwidth, trim={0 0 0 1cm},clip]{cr_flido-output_vel.jpg}
      \end{center} 
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.89\textwidth, trim={0 0 0 1cm},clip]{cr_fkryo-output_vel.jpg}\\[.1em]
        \includegraphics[width=.89\textwidth, trim={0 0 0 1cm},clip]{cr_fpsar-output_vel.jpg}
      \end{center} 
    \end{column}
  \end{columns}
\end{frame}
...
%    \begin{center}
%    \vskip-1.2cm
%      \includegraphics[width=.7\textwidth]{gr-output_str.jpg}
%    \end{center}
%  \end{column}
%\end{columns}
%\end{frame}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{.7\textwidth}
      \begin{center}
      \vskip-1cm
        \includegraphics[width=.95\textwidth]{crfeu-output_str.jpg}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \vskip-.5cm
  \begin{center}
    \includegraphics[width=.6\textwidth]{platform2.png}\\
    \includegraphics[width=.6\textwidth]{gsg2022_ts1.png}
  \end{center}
%  \begin{columns}[T]
%    \begin{column}{.5\textwidth}
%     
...
%    \begin{column}{.5\textwidth}
%      \begin{center}
%          \includegraphics[width=.97\textwidth]{gsg2022_ts1.png}
%        \end{center}  
%    \end{column}
%  \end{columns}
  \begin{center}
...
%      currently in use).
    \item A dense velocity field for accurate estimation of ground/tectonic motions in the region will help to develop a better understanding of complex kinematic field.
    \item The continuous monitoring of the networks gives useful results for the effect of strong earthquakes or other ``abrupt'' phenomena; small, dense networks 
      ...
      \item  Our plan: grow up our team and support monitoring in an operational manner..
  \end{itemize}
\end{frame}
\note{}
