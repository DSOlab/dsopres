...
\begin{frame}
  ...
  \begin{center}
%  \vskip-.5cm
    \includegraphics[width=.6\textwidth]{geotectonic.jpg}
  \end{center}
  \begin{footnotesize}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth, trim={0 0 0 1cm},clip]{cr_flepe-output_vel.jpg}\\[.1em]
        \includegraphics[width=.97\textwidth, trim={0 0 0 1cm},clip]{cr_flido-output_vel.jpg}
      \end{center} 
    \end{column}
    \begin{column}{.5\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth, trim={0 0 0 1cm},clip]{cr_fkryo-output_vel.jpg}\\[.1em]
        \includegraphics[width=.97\textwidth, trim={0 0 0 1cm},clip]{cr_fpsar-output_vel.jpg}
      \end{center} 
    \end{column}
  \end{columns}
\end{frame}
