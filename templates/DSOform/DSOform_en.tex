...
\def\What{Position} % Your title
\def\Where{} % Your department/institution
\def\Address{9, H. Polytechniou Str., } % Your address
\def\CityZip{GR-15780, Zographou, Greece, } % Your city, zip code, country, etc
\def\Email{E-mail: dempar@central.ntua.gr} % Your email address
\def\TEL{Phone: (030) 210 772 2666} % Your phone number
...
\large\hspace{1in}\textbf{NATIONAL TECHNICAL UNIVERSITY OF ATHENS} \hfill ~\\[0.05in] % First line of institution name, adjust hspace if your logo is wide
\hspace{1in}\textbf{SCHOOL OF RURAL \& SURVEYING ENGINEERING} \hfill ~\\[0.05in]  % Second line of institution name, adjust hspace if your logo is wide
\hspace{1in}\textbf{DIONYSOS SATELLITE OBSERVATORY} \hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
...
\hspace{\fill}\parbox[t]{5.85in}{ % Create a box for your details underneath the horizontal rule on the right
