...
\def\Who{Ονομ/επώνυμο} % Your name
...
\def\TEL{Τηλ: 210 772 2666} % Your phone number
...
\hspace{1in}\textbf{ΣΧΟΛΗ ΑΓΡΟΝΟΜΩΝ \& ΤΟΠΟΓΡΑΦΩΝ ΜΗΧΑΝΙΚΩΝ} \hfill ~\\[0.05in]  % Second line of institution name, adjust hspace if your logo is wide
