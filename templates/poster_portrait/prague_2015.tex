...
\title{Routine Analysis of GNSS Stations in South Aegean:} % Poster title
\subtitle{Processing Scheme, Results and Dissemination of Products and Data}
\author{Xanthos Papanikolaou, Demitris Anastasiou, Aggeliki Marinou, Vangelis Zacharis, and Demitris Paradissis} % Author(s)

\institute{National Technical University of Athens, School of Rural and Surveying Engineering} % Institution(s)
...
\begin{figure}
  \centering
  \includegraphics[width=0.4\onecolwid]{Diagram1.eps}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\onecolwid]{tspan.png}
...
\begin{figure}
    \includegraphics[width=1.0\onecolwid]{sa_gpsvel.jpg}
