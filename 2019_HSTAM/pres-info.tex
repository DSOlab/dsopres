...
\urlhome{https://dsolab.github.io/StrainTool}  %% homepage
...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{StrainTool -  Improving the Mapping of Tectonic Strain in Eurasia }

%% The team prepare this presentation
\presteam{
\underline{D.Anastasiou}\textsuperscript{1,2},
X. Papanikolaou\textsuperscript{1,2},
V. Kapetanidis\textsuperscript{1,3},
V. Tsironi\textsuperscript{1},
A. Ganas\textsuperscript{1},
D. Paradissis\textsuperscript{2}}

%% Organizations of the team
\presorgn{\textsuperscript{1}Institute of Geodynamics - National Observatory of Athens\\
\textsuperscript{2}Dionysos Satellite Observatory - Higher Geodesy Laboratory,\\ National Technical University of Athens\\
\textsuperscript{3}Department of Geology and Geoenvironment, National and Kapodistrian University of Athens  
}
...
%% OR conf logo....
\conflogo{\includegraphics[width=.8\textwidth,draft=false]{Figs/logo-12HSTAM.jpg}}
