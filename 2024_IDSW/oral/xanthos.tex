...
\begin{frame}
  ...
  \begin{center}
    This study was funded under the project PREPARE (HFRI PN:15562) in the framework of H.F.R.I
call “Basic research Financing (Horizontal support of all Sciences)” under the National Recovery
and Resilience Plan “Greece 2.0” funded by the European Union –NextGenerationEU
  \end{center}
  \vskip-1cm
  \begin{columns}[T]
    \begin{column}{.4\textwidth}
      \begin{center}
        \includegraphics[width=.97\textwidth]{18-10-19_ELIDEK_logo_ENG_400x140.jpg}
      \end{center}
    \end{column}
    \begin{column}{.6\textwidth}
       \begin{center}
         \includegraphics[width=.97\textwidth]{Greece 2.0_NextGeneration_en_1.jpg}
       \end{center}
    \end{column}
  \end{columns}
