...
%% -----------------------------------------------------------------------------
%% The title of the thesis
\prestitle{An Automated Platform for GNSS Processing and Time-Series Analysis in a Complex Geodynamic Region}

%% The team prepare this presentation
\presteam{
\underline{Dimitrios Anastasiou},
Georgios Mytilinaios, Alexandros Mylonas, Georgios Serelis, Xanthos Papanikolaou, Vangelis Zacharis, Maria Tsakiri 
}

%% Organizations of the team
\presorgn{Dionysos Satellite Observatory\\ School of Rural Surveying and Geoinformatics Engineering \\ National Technical University of Athens\\
}
...
%% OR conf logo....
\conflogo{\includegraphics[width=.5\textwidth,draft=false]{Figs/EUREF2026_v2.png}
\includegraphics[width=.45\textwidth,draft=false]{Figs/Logo_organizers_hd_1.png}}
