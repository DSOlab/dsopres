...
\documentclass[aspectratio=169, customfont, printbib]{Classes/beamerPub}%%  
% ******************************************************************************
% ******************************* Class Options ********************************
...
%  \tableofcontents
    \begin{itemize}\setlength\itemsep{1em}
        \item GNSS Networks in Greece
        \item Upgrade Processing and analysis platform
        \item Results \& Outputs
        \item Time series analysis results
