...
% ------------------------------------------------------------------------------
\begin{frame}\frametitle{The Data Set and metadata challenges}\framesubtitle{}
\vskip-1.5cm
...
\begin{itemize}
    \item[$\delta \tau$] $(= \tau - \tau_0)$: time elapsed since the central epoch $\tau_0$ [yr] 
    \item[$A$]:	station velocity [m/yr] 
    \item[$B$]:	position intercept at $\tau_0$ [m] 
    ...
    \item[$J_k$]: magnitude of the k-th step offset [m], modelled by the Heaviside function $H(\tau − \tau_k)$ activating at epoch $\tau_k$;	ν is the total number of offsets 
    \item[$A_i^l, 	A_i^e$]: amplitudes of the i-th logarithmic and exponential PSD terms [m]
    \item[$\tau_I^l, \tau_i^e$]: relaxation time constants of the i-th logarithmic and exponential PSD terms [yr] 
    ...
    \item[$nₗ, 	nₑ$]: number of logarithmic and exponential PSD terms 
\end{itemize}
\begin{flushright}
\citep{itrf2020}
\end{flushright}
...
\note{}
 ...
 % ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{Impact of PSD Modelling on Greek GNSS Time Series}
  ...
  \begin{columns}[T]
    ...
    \end{column}
     \begin{column}{.33\textwidth}
      \begin{center}
        [ToDO] Differences in PSd parameters....
%        \includegraphics[width=.97\textwidth]{VLSM_ts.png}\\
%        \includegraphics[width=.97\textwidth]{VLSM_res.png} 
      \end{center}      
    \end{column}
